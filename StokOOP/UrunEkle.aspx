<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="UrunEkle.aspx.cs" Inherits="StokOOP.UrunEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     ...
     <form runat="server" class="form-group">  
        ...
        <br />
         ...
         <br />
        <div>
            <asp:Button ID="Button1" runat="server" Text="Ürün Kaydet" CssClass="btn-primary" OnClick="Button1_Click" />
        </div>
