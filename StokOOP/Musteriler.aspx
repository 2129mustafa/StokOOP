<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Musteriler.aspx.cs" Inherits="StokOOP.Musteriler" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                       ...
                       <td><asp:HyperLink NavigateUrl='<%# "~/MusteriSil.aspx?MUSTERIID=" + Eval("MUSTERIID") %>' 
