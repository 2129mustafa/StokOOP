<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PersonelEkle.aspx.cs" Inherits="StokOOP.PersonelEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form runat="server" class="form-group">  
        ...
        <br />
        <div>
            <asp:Button ID="Button1" runat="server" Text="Personeli Kaydet" CssClass="btn-primary" OnClick="Button1_Click"/>
        </div>
